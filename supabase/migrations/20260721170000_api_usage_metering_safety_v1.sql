-- Safety follow-up for Astro API usage metering.
-- This migration requires 20260721161000_api_usage_metering_v1.sql first.
...
begin
    ...
    -- A request identifier is globally unique. Serialize first use across consumers.
    ...
    -- Release abandoned reservations against the month in which each was admitted.
    for v_expired in
        with expired as (
