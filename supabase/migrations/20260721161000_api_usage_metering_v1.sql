-- Shared API rate limiting and usage metering for the Astro project only.
-- Apply through the Supabase migration runner after application CI and review pass.
